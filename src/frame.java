...
public class frame extends JFrame {
    ...
    public static void teamScreen() {
        ...
        teamFrame.setBackground(Color.decode("#38003C"));
        ...
        pitchPanel.setBackground(Color.decode("#38003C"));
        pitchPanel.setLayout(new BorderLayout());
        JLabel pitchLabel = new JLabel(new ImageIcon("C:\\Users\\Daniel\\IdeaProjects\\FYP\\pitch.png"));
        pitchLabel.setBounds(25, 20, 1400, 1000);
        pitchPanel.add(pitchLabel, BorderLayout.CENTER);
        pitchPanel.setOpaque(false);
        pitchPanel.setLayout(null);
        teamFrame.setContentPane(pitchPanel);
        ...
        contentPane.setBackground(Color.decode("#00FF85"));
        contentPane.setLayout(null);
        teamFrame.add(contentPane);

        //Creating the search for players
        String[] gks = {"Alisson", "Ederson", "Leno", "Vicario", "Ramsdale", "Raya"};

        JComboBox gk1 = new JComboBox(gks);
        gk1.setBounds(1700, 100, 100, 50);
        gk1.setEditable(true);
        teamFrame.add(gk1);
